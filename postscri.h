/*
 * $Id: postscri.h,v 1.2 1992/10/02 01:02:32 craigs Exp $
 *
...
extern void StartJob      (FILE *, char *, int, int, char *, char *, int, int, char *, int, int, int, char *, char *, struct PaperMetrics *, int);
